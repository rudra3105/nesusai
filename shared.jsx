...
function useReveal() {
  useEffect(() => {
    const els = document.querySelectorAll('.reveal:not(.in), .reveal-scale:not(.in), .reveal-slide:not(.in)');
      ...
      <svg width={size} height={size} viewBox="0 0 40 40" fill="none">
        <defs>
          <linearGradient id="lg1" x1="0" y1="0" x2="1" y2="1">
            ...
            <stop offset="1" stopColor="#ff7787" />
          </linearGradient>
        </defs>
...
function Footer({ onNav }) {
  return (
    <footer style={{
      ...
      paddingTop: 100,
      paddingBottom: 32,
      background: 'linear-gradient(180deg, transparent, rgba(244,63,94,0.02))',
