...
function App() {
  ...
  aUseEffect(() => {
    ...
    // glow proportional to accent
    root.style.setProperty('--accent-glow', t.accent + '38');
    // toggle grain on body via class
    if (t.showGrain) {
      document.body.classList.remove('no-grain');
    } else {
      document.body.classList.add('no-grain');
    }
  }, [t.accent, t.showGrain]);
      ...
      <TweaksPanel title="Tweaks">
        <TweakSection label="Brand">
          <TweakColor
            ...
            options={['#f43f5e', '#5eead4', '#3b82f6', '#d4754e', '#f43f5e']}
          />
        </TweakSection>
