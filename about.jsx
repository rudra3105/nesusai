...
const TIMELINE = [
  { y: '2021', t: 'Founded in Bengaluru', b: 'Two founders, one rented desk. First contract: a fintech reconciliation tool.' },
  { y: '2022', t: 'Team of six', b: 'Mobile and security disciplines added. First seven-figure annual retainer signed.' },
  { y: '2023', t: 'AI practice launches', b: 'First production RAG system shipped. Internal eval framework built.' },
  { y: '2024', t: 'SOC2 Type II', b: 'Compliance program in place. Team of eleven across four time zones.' },
    ...
    <main className="page-enter" data-screen-label="03 About">
      ...
      <section style={{ paddingTop: 200, paddingBottom: 100, position: 'relative', overflow: 'hidden' }}>
        ...
        <div className="container">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 60, alignItems: 'start' }} className="about-page-grid">
            <p className="reveal text-dim" data-delay="2" style={{ fontSize: 22, lineHeight: 1.5, maxWidth: 560 }}>
              Nesus AI is a small product studio in Bengaluru. We build websites, apps, software, AI systems, e-commerce, security, and data infrastructure for teams who care about what they ship.
            </p>
      ...
      <section style={{ background: 'var(--bg-2)', borderTop: '1px solid var(--border)', borderBottom: '1px solid var(--border)' }}>
        ...
        <style>{`
          @media (max-width: 800px) {
            ...
            .values-grid > * { border-right: 0 !important; border-bottom: 1px solid var(--border) !important; padding-left: 0 !important; padding-right: 0 !important; }
      ...
      <section style={{ background: 'var(--bg-2)', borderTop: '1px solid var(--border)', borderBottom: '1px solid var(--border)' }}>
        <div className="container">
          <SectionHeader
            eyebrow="HISTORY"
            title='From a desk in Bengaluru to <span class="italic-serif" style="color: var(--accent)">142 ships</span>.'
          />
          <div style={{ position: 'relative', paddingLeft: 40 }}>
            {/* vertical line */}
            <div style={{ position: 'absolute', left: 8, top: 6, bottom: 6, width: 1, background: 'var(--border-2)' }} />
            {TIMELINE.map((e, i) => (
              <div key={i} className="reveal" data-delay={Math.min(i, 4)} style={{ position: 'relative', marginBottom: 56, display: 'grid', gridTemplateColumns: '120px 1fr', gap: 40 }}>
                {/* dot */}
                <div style={{
