...
const TEAM = [
  { name: 'Aarav Mehta', role: 'Founder, AI', color: '#ffffff' },
  { name: 'Sana Qureshi', role: 'Founder, Design', color: '#a0a0a0' },
  { name: 'Dev Patel', role: 'Eng Lead, Platform', color: '#999999' },
  { name: 'Lina Park', role: 'Eng Lead, Mobile', color: '#d4d4d4' },
  { name: 'Marco Rinaldi', role: 'Security', color: '#ffffff' },
  { name: 'Yui Tanaka', role: 'Data', color: '#a0a0a0' },
  { name: 'Tom Berger', role: 'Product', color: '#999999' },
  { name: 'Aisha Khan', role: 'Research', color: '#d4d4d4' },
];
