  ...
  return (
    <div
      ...
      style={{
        ...
        background: hover ? 'rgba(244,63,94,0.02)' : 'transparent',
      }}>
      ...
      <style>{`
        @media (max-width: 1100px) {
          .services-page-row { grid-template-columns: 80px 1fr 60px !important; gap: 24px !important; }
          .services-page-row > div:nth-child(3) { grid-column: 1 / 4 !important; padding-top: 8px; }
        }
        @media (max-width: 600px) {
          .services-page-row { grid-template-columns: 56px 1fr !important; gap: 16px !important; }
          .services-page-row > div:nth-child(3) { grid-column: 1 / 3 !important; }
          .services-page-row > div:nth-child(4) { grid-column: 1 / 3 !important; justify-content: flex-start !important; }
        }
      `}</style>
    </div>
  );
