      ...
      <div style={{
        ...
        <div style={{
          ...
          <button onClick={onClose} style={{
            ...
            onMouseEnter={e => { e.currentTarget.style.background = 'var(--accent)'; e.currentTarget.style.color = '#07080a'; e.currentTarget.style.borderColor = 'var(--accent)'; }}
        ...
        {/* Body */}
        <div style={{ overflowY: 'auto', flex: 1, padding: '48px 56px' }} className="modal-scroll">
                  ...
                  {c.outcome.map((o, i) => (
                    <li key={i} style={{
                      ...
                      <div style={{
                        ...
                        background: c.color, color: '#07080a',
                        display: 'flex', alignItems: 'center', justifyContent: 'center',
                        flexShrink: 0,
...
function Cases({ onNav, onOpenCase }) {
  ...
  return (
    <main className="page-enter" data-screen-label="04 Work">
      {/* Hero */}
      <section style={{ paddingTop: 200, paddingBottom: 80, position: 'relative', overflow: 'hidden' }}>
