        ...
        <div className="container">
          <div style={{
                          ...
                          {services.map(s => {
                            ...
                            return (
                              <button key={s} onClick={() => toggleService(s)} style={{
                                ...
                                background: on ? 'rgba(244, 63, 94, 0.06)' : 'transparent',
                                color: 'var(--text)',
                                textAlign: 'left',
                                cursor: 'pointer',
            ...
            <aside className="reveal" data-delay="1" style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
              ...
              <div style={{ padding: 24, borderRadius: 'var(--radius-lg)', background: 'rgba(244, 63, 94, 0.04)', border: '1px solid rgba(244, 63, 94, 0.25)' }}>
