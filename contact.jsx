...
function Contact({ onNav }) {
  ...
  return (
    <main className="page-enter" data-screen-label="05 Contact">
      {/* Hero */}
      <section style={{ paddingTop: 200, paddingBottom: 60, position: 'relative', overflow: 'hidden' }}>
        ...
        <div className="container">
          ...
          <p className="reveal text-dim" data-delay="2" style={{ fontSize: 20, lineHeight: 1.5, maxWidth: 700, marginBottom: 0 }}>
            Tell us what you are building. We'll reply within four hours (Mon–Fri, IST) with next steps — usually a 30-minute discovery call.
          </p>
        </div>
      </section>
                      ...
                      <>
                        ...
                        <div className={`field ${errors.message ? 'error' : ''}`}>
                          ...
                          <div className="mono text-muted" style={{ fontSize: 11, letterSpacing: '0.1em', marginTop: 6 }}>
                            {form.message.length} chars · prefer email? <a href="mailto:hello@nesus.ai" style={{ color: 'var(--accent)' }}>hello@nesus.ai</a>
                          </div>
                        </div>
                      </>
                    )}
              ...
              <div className="card" style={{ padding: 28 }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
                  <div>
                    ...
                    <a href="mailto:hello@nesus.ai" style={{ fontSize: 17, color: 'var(--text)', textDecoration: 'none' }}>hello@nesus.ai</a>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <div style={{ fontSize: 15 }}>Mon–Fri, 09:00–19:00</div>
                  </div>
                </div>
              </div>
...
function SuccessView({ form, onNav }) {
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 28, padding: '12px 0', animation: 'stepIn 0.6s cubic-bezier(0.2, 0.8, 0.2, 1)' }}>
      ...
      {/* Brief summary card */}
      <div style={{ marginTop: 16, padding: 24, border: '1px dashed var(--border-2)', borderRadius: 14, display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
        <div>
